...
# //    optional LYSegment segment = 1;
# //    optional LYCoordinate location = 2;
...
# enum LYMsgType {
#     LY_VOID = 0X01;
#     LY_RET_CODE = 0x02;	//message RetCode
#     LY_TRAFFIC_SUB  = 0x04;	//message TrafficSub
#     LY_TRAFFIC_REPORT = 0x05;	//message TrafficReport
#     LY_DEVICE_REPORT = 0x06;	//message DeviceReport
#     LY_TRAFFIC_PUB = 0x13;	//message TrafficPub
# }
# 
# message LYMsgOnAir {
...
module Tss
  ::Protobuf::OPTIONS[:"java_package"] = "com.luyun.easyway95.shared"
  ::Protobuf::OPTIONS[:"java_outer_classname"] = "TSSProtos"
  class LYCoordinate < ::Protobuf::Message
    defined_in __FILE__
    required :double, :lng, 1
    required :double, :lat, 2
  end
  class LYLocation < ::Protobuf::Message
    defined_in __FILE__
    required :double, :lng, 1
    required :double, :lat, 2
    optional :string, :name, 3
  ...
  class LYSegment < ::Protobuf::Message
    defined_in __FILE__
    required :LYCoordinate, :start, 1
    required :LYCoordinate, :end, 2
    optional :string, :road, 3
  end
  class LYRoute < ::Protobuf::Message
    defined_in __FILE__
    required :int32, :identity, 1
    repeated :LYSegment, :segments, 2
  end
  class LYDirection < ::Protobuf::Enum
    defined_in __FILE__
    LY_UNKNOWN = value(:LY_UNKNOWN, 0)
    LY_EAST = value(:LY_EAST, 1)
    LY_NORTHEAST = value(:LY_NORTHEAST, 2)
    LY_NORTH = value(:LY_NORTH, 3)
    LY_NORTHWEST = value(:LY_NORTHWEST, 4)
    LY_WEST = value(:LY_WEST, 5)
    LY_SOUTHWEST = value(:LY_SOUTHWEST, 6)
    LY_SOUTH = value(:LY_SOUTH, 7)
    LY_SOUTHEAST = value(:LY_SOUTHEAST, 8)
  end
  class LYSegmentTraffic < ::Protobuf::Message
    defined_in __FILE__
    required :LYSegment, :segment, 1
    optional :int64, :timestamp, 3
    required :LYDirection, :direction, 4
  ...
  class LYRoadTraffic < ::Protobuf::Message
    defined_in __FILE__
    required :string, :road, 1
    optional :int64, :timestamp, 2
    repeated :LYSegmentTraffic, :segment_traffics, 3
  ...
  class LYCityTraffic < ::Protobuf::Message
    defined_in __FILE__
    optional :string, :city, 1
    optional :int64, :timestamp, 2
    repeated :LYRoadTraffic, :road_traffics, 3
  end
  class LYCrontab < ::Protobuf::Message
    defined_in __FILE__
    class LYCronType < ::Protobuf::Enum
      defined_in __FILE__
      LY_REP_MINUTE = value(:LY_REP_MINUTE, 1)
      LY_REP_HOUR = value(:LY_REP_HOUR, 2)
      LY_REP_DOM = value(:LY_REP_DOM, 4)
      LY_REP_MONTH = value(:LY_REP_MONTH, 8)
      LY_REP_DOW = value(:LY_REP_DOW, 16)
    end
    required :LYCronType, :cron_type, 1
    optional :int64, :minute, 2
    optional :int64, :hour, 3
  ...
  class LYTrafficSub < ::Protobuf::Message
    defined_in __FILE__
    class LYOprType < ::Protobuf::Enum
      defined_in __FILE__
      LY_SUB_CREATE = value(:LY_SUB_CREATE, 1)
      LY_SUB_DELETE = value(:LY_SUB_DELETE, 2)
      LY_SUB_UPDATE = value(:LY_SUB_UPDATE, 3)
    end
    class LYPubType < ::Protobuf::Enum
      defined_in __FILE__
      LY_PUB_ADHOC = value(:LY_PUB_ADHOC, 1)
      LY_PUB_EVENT = value(:LY_PUB_EVENT, 2)
      LY_PUB_CRON = value(:LY_PUB_CRON, 3)
    end
    required :string, :city, 1
    required :LYRoute, :route, 2
    required :LYOprType, :opr_type, 3
  ...
  class LYTrafficPub < ::Protobuf::Message
    defined_in __FILE__
    required :int32, :route_id, 1
    required :LYCityTraffic, :city_traffic, 2
  end
  class LYDeviceReport < ::Protobuf::Message
    defined_in __FILE__
    required :string, :device_id, 1
    required :bytes, :device_token, 2
    required :string, :device_name, 3
  ...
  class LYSamplePoint < ::Protobuf::Message
    defined_in __FILE__
    required :LYCoordinate, :sp_coordinate, 1
    required :int64, :timestamp, 2
    optional :double, :altitude, 3
    optional :double, :course, 4
  end
  class LYTrafficReport < ::Protobuf::Message
    defined_in __FILE__
    repeated :LYSamplePoint, :points, 1
  end
  class LYRetCode < ::Protobuf::Enum
    defined_in __FILE__
    LY_SUCCESS = value(:LY_SUCCESS, 0)
    LY_VERSION_IMCOMPATIBLE = value(:LY_VERSION_IMCOMPATIBLE, 273)
    LY_VERSION_LOW = value(:LY_VERSION_LOW, 291)
    LY_PARTY_ERROR = value(:LY_PARTY_ERROR, 553)
    LY_MSG_TYPE_ERROR = value(:LY_MSG_TYPE_ERROR, 914)
    LY_TIMEOUT = value(:LY_TIMEOUT, 1171)
    LY_OTHER_ERROR = value(:LY_OTHER_ERROR, 2457)
  end
  class LYParty < ::Protobuf::Enum
    defined_in __FILE__
    LY_CLIENT = value(:LY_CLIENT, 1)
    LY_TSS = value(:LY_TSS, 2)
    LY_TC = value(:LY_TC, 3)
  end
  class LYMsgType < ::Protobuf::Enum
    defined_in __FILE__
    LY_VOID = value(:LY_VOID, 1)
    LY_RET_CODE = value(:LY_RET_CODE, 2)
    LY_TRAFFIC_SUB = value(:LY_TRAFFIC_SUB, 4)
    LY_TRAFFIC_REPORT = value(:LY_TRAFFIC_REPORT, 5)
    LY_DEVICE_REPORT = value(:LY_DEVICE_REPORT, 6)
    LY_TRAFFIC_PUB = value(:LY_TRAFFIC_PUB, 19)
  end
  class LYMsgOnAir < ::Protobuf::Message
    defined_in __FILE__
    ...
    required :LYMsgType, :msg_type, 4
    extensions 128..255
    optional :LYRetCode, :ret_code, 17
    optional :LYDeviceReport, :device_report, 19
    optional :LYTrafficSub, :traffic_sub, 36
    optional :LYTrafficPub, :traffic_pub, 51
    optional :LYTrafficReport, :traffic_report, 65
  end
end