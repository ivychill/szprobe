#this file must be copied to /etc/init.d/
#!/bin/bash
#
RETVAL=0;
...
su - roadclouding -c "cd $APP_HOME && script/daemon start utils/fake-traffics-copy-of-201212.rb"
...
su - roadclouding -c "cd $APP_HOME && script/daemon stop utils/fake-traffics-copy-of-201212.rb"
